...
int main()
{
    char *months[SIZE] = {"Jan", "February", "March", "April",
                      "May", "June", "July", "Aug",
                      "Sep", "Oct", "Nov", "December"};
    int i;
    
    // Another way to create an array of strings BUT these can be edited
    // char my_string[5][10] = {"Me", "You", "Us", "Them", "They"};
    ...
    */
    ...
    for(i = 0; i < SIZE; i++)
    {
        ...
        //alternative method to display the strings using the puts()
        //puts(months[i]);
