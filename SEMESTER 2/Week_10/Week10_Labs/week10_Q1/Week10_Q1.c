...
int main()
{
    ...
    {
        //if characters are different add 1
        if(file1 != file2)
        {
            result =  result + 1;
        ...
        //if characters are the same add nothing
        else
        {
            result = result + 0;
    ...
    //if there are one or more different characters files are different
    if(result > 0)
    {
        printf("\nFiles are different");
    ...
    //if there are no different characters files are the same
    else
    {
        printf("\nFiles are same");
